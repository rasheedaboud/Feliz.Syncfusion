...
module SfAppBar =
    ...
    type Spacer =
        ...
        static member inline cssClass (value: string list) = Interop.mkAttr "cssClass" [(["e-appbar-spacer"] @value |> Feliz.prop.classes)]

    [<Erase>]
    type Separator =
        static member inline create xs = Interop.createElement "div" [prop.className "e-appbar-separator"]
        static member inline cssClass (value: string list) = Interop.mkAttr "cssClass" [(["e-appbar-separator"] @value |> Feliz.prop.classes)]
    ...
    type SfAppBar  =
        ...
        static member inline children(children) =
            Interop.mkAttr "children" children
        /// <summary>
        ...
        /// </summary>
        /// <default>'Top'</default>
        static member inline position(position: AppBarPosition) = Interop.mkAttr (nameof position) position

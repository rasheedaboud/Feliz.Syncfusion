...
const cases = [
  ...
  ["FileUploader", SfFileUploader_uploader, { autoUpload: false, multiple: false, allowedExtensions: ".pdf", cssClass: "uploader-initial" }],
...
const updates = {
  ...
  FileUploader: { autoUpload: false, multiple: false, allowedExtensions: ".pdf", cssClass: "uploader-updated" },
